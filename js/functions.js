...
document.addEventListener('scroll', function () {
    ...
    if (slider && pageMenu) {
        ...
        // If the bottom of the slider is above the top of the viewport
        if (sliderBottom <= 0) {
            pageMenu.style.display = ''; // Show #page-menu
        } else {
            pageMenu.style.display = 'none'; // Hide #page-menu
        }
    }
});

// Initially hide the #page-menu since the #slider is visible
